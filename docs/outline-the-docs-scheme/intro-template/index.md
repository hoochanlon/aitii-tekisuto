...
本规范虽无法达到正式投标文件的水准，但可作为实用参考，旨在提供清晰、规范、可操作的排版指引，供大家借鉴并根据实际情况灵活调整。
...
封面不需要页码，但保留目录页码可参考此视频：https://www.bilibili.com/video/BV1aQ4y1u7Vr ，同时也可借鉴其排版。目录在七八页以上建议换成非罗马数字，毕竟太小众也看不懂，影响阅览体验。
